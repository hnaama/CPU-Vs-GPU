...
void WeirdEntity::update(float deltaTime, int, int) {
    life -= deltaTime;
    morphTime += deltaTime;
...
void WeirdEntity::render(std::vector<Triangle3D>& triangles) const {
...
void WeirdEntity::generateSpikyTriangles(std::vector<Triangle3D>& triangles, float) const {
...
void WeirdEntity::generateBlobTriangles(std::vector<Triangle3D>& triangles, float) const {
    int segments = 12;
...
void WeirdEntity::generateFractalTriangles(std::vector<Triangle3D>& triangles, float) const {
...
void WeirdEntity::generateRibbonTriangles(std::vector<Triangle3D>& triangles, float) const {
    int segments = 20;
...
void WeirdEntity::generateOrbTriangles(std::vector<Triangle3D>& triangles, float) const {
    int rings = 6;
    int segments = 8;
...
void WeirdEntity::generateFragmentTriangles(std::vector<Triangle3D>& triangles, float) const {
    int fragments = 15;
...
void WeirdEntity::generatePolyhedronTriangles(std::vector<Triangle3D>& triangles, float) const {
...
void WeirdVisualManager::update(float deltaTime) {
    ...
    if (spawnTimer >= spawnInterval && (int)entities.size() < maxEntities) {
        spawnTimer = 0;
